    ...
    <div class="col-lg-9">
      <div className="bg-white h-100 pt-4 ">
        ...
        <div className="container px-4 align-items-center justify-content-center">
          <h6 className='mt-4 mb-3' style={{fontSize: '17px'}}>My Refences & Ratings</h6>
          ...
          <button className='btn btn-secondary mt-3' onClick={handleShow}>see more</button>
          <OffCanvas show={show} handleClose={handleClose} />
        </div>
      </div>
    </div>
    <div class="col-lg-3">
      <div className="container-fluid bg-white h-100 pt-4 shadow-sm" >
